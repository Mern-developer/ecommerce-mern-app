...
<Box container sx={{ display: { md: "flex" }, my:3 }}>
            ...
            <Box>
              <Grid item sx={{ mx: 1 }}>
                ...
                Measurement:<br/>
                  {backendData.Measurement?.mtrs1}<br/>
                  {backendData.Measurement?.mtrs2}<br/>
                  {backendData.Measurement?.mtrs3}<br/>
                  {backendData.Measurement?.mtrs4}<br/>
                  {backendData.Measurement?.mtrs5}<br/>
...
export default ProductDetailnishat;