...
<Box container sx={{ display: { md: "flex" }, my:3 }}>
            ...
            <Box>
              <Grid item sx={{ mx: 1 }}>
                ...
                Measurement:<br/>
                  {backendData.detailing?.points1}<br/>
                  {backendData.detailing?.points2}<br/>
                  {backendData.detailing?.points3}<br/>
                  {backendData.detailing?.points4}<br/>
                  {backendData.detailing?.points5}<br/>
                  {backendData.detailing?.points6}<br/>
                  {backendData.detailing?.points7}<br/>
                  {backendData.detailing?.points8}<br/>
                  {backendData.detailing?.points9}<br/>
                  {backendData.detailing?.points10}<br/>
...
export default ProductDetailWatch;