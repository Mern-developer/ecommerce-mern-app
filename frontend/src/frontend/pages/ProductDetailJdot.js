...
navigate('/shopping-cart')
  ...
  return (
    ...
    >
      ...
      <Box container sx={{ display: { md: "flex" } }}>
        <Box>
          <Typography
            component={"div"}
            sx={{
        ...
        <Box>
          <Grid item sx={{ mx: 1 }}>
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <span style={{ fontSize: "20px", color: "#9e9e9e" }}> Price :</span>
            &nbsp;{backendData.price}
            <br />
            <span
              style={{
            ...
            <Typography variant="body1" sx={{ color: "#9e9e9e" }} gutterBottom>
              {backendData.desc}
            </Typography>
            ...
            <Typography
              variant="span"
              sx={{ mt: 2, fontSize: "18px", letterSpacing: "1px" }}
              gutterBottom
              component="div"
            >
              {backendData.note}
        ...
        <Box>
          <Grid container>
            <Grid item md={9} xs={12}>
              <Grid item xs={12} sx={{ display: { md: { width: "400px" } } }}>
                <Root>
                  <Box
                    sx={{
                      border: 1,
                  ...
                  >
                    ...
                    <Typography component={"div"} gutterBottom>
                      <strong>Shipping Policy: </strong>Shipping Time: Shipping
                      time for order delivery within Pakistan is 7 working days
                      and for outside Pakistan 15 working days.
                    </Typography>
...
export default ProductDetailJdot;
